...
export const getListQuestion = (page, len, dateFrom, dateTo, sortBy, nameVal) => async (dispatch) => {
    ...
    dispatch(getTotalListQuestion(total))
    const data = await responses.json()
    return dispatch({ type: actionTypes.LIST_QUESTION, payload: data })
}

const getTotalListQuestion = (data) => (dispatch) => {
    return dispatch({ type: actionTypes.TOTAL_LIST_QUESTION, payload: data })
}
